...
class UIHelper {
  ...
  static EdgeInsets getDefaultPadding() {
    if (ScreenUtil().orientation == Orientation.portrait) {
      return EdgeInsets.all(12.0.w);
    } else {
      return EdgeInsets.all(12.0.h);
    }
  }

  static EdgeInsets getIconPadding() {
    if (ScreenUtil().orientation == Orientation.portrait) {
      return EdgeInsets.all(10.0.w);
    } else {
      return EdgeInsets.all(4.0.h);
    }
  }
  ...
  static final Map<String, Color> _typeColorMap = {
    ...
    "Water": Colors.blue,
    "Electric": Colors.yellow.shade900,
    "Rock": Colors.grey,
    "Ground": Colors.brown,
  ...
  static Color getColorFromType(String type) {
    if (_typeColorMap.containsKey(type)) {
      return _typeColorMap[type] ?? Colors.pink;
    } else {
      return Colors.pink;
    }
  }
